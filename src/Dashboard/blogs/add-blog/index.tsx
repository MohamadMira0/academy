...
const AddBlog = () => {
  ...
  const addBlogMutation = useMutation(createBlog, {
    onSuccess: () => {
      queryClient.invalidateQueries(['blogs']);
    },
  });
  const handleSubmit = async (
    values: IInitialValuesAddBlogs,
    { setSubmitting }: FormikHelpers<IInitialValuesAddBlogs>,
  ) => {
    try {
          ...
          <Form>
            ...
            <div className="mb-4">
              ...
              <Field
                ...
                placeholder="محتوى المقالة باللغة العربية"
                className="appearance-none text-black block w-full px-3 shadow-switch-1 text-gray-700 border border-gray-300 rounded-sm border-none py-4"
                cols="30"
                rows="6"
                maxLength="300"
            ...
            <div className="mb-4">
              <label
                ...
                htmlFor="title_en"
              >
                عنوان المقالة باللغة الإنكليزية
              </label>
              <Field
                className="appearance-none text-black block w-full px-3 shadow-switch-1 text-gray-700 border border-gray-300 rounded-sm border-none py-4"
            ...
            <div className="mb-4">
              ...
              >
                محتوى المقالة باللغة الإنكليزية
              </label>
              <Field
                as="textarea"
                name="description_en"
                id="description_en"
                // value={values.description}
                placeholder="محتوى المقالة باللغة الإنكليزية"
                className="appearance-none text-black block w-full px-3 shadow-switch-1 text-gray-700 border border-gray-300 rounded-sm border-none py-4"
                cols="30"
                rows="6"
                maxLength="300"
